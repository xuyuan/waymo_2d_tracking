...
class ReceptiveFieldBlockB(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1, scale=0.1, visual=1):
        super(ReceptiveFieldBlockB, self).__init__()
        self.scale = scale
        self.out_channels = out_planes
...
class ReceptiveFieldBlockA(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1, scale=0.1):
        super(ReceptiveFieldBlockA, self).__init__()
        self.scale = scale
        self.out_channels = out_planes
